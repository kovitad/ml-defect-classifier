...
def train_cypress_model(data, config, mlflow_config):
    ...
    X_text = tfidf.fit_transform(data['Error_Info'])
    ...
    with mlflow.start_run():
        ...
        mlflow.sklearn.log_model(model, "CypressModel")
        
        logging.info(f"Cypress Model Accuracy: {accuracy}")
